...
\include{thesis_DE/chapters/methoden}
\include{thesis_DE/chapters/ausgabe}
\include{thesis_DE/chapters/vergleich}
\include{thesis_DE/chapters/fazit}


%%%----------------------------------------------------------
\MakeBibliography[maxnames=99]                  % Quellenverzeichnis
%%%----------------------------------------------------------
